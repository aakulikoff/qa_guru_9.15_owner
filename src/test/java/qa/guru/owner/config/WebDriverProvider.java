...
public class WebDriverProvider implements Supplier<WebDriver> {
    ...
    private SmallWebDriverConfig config;

    public WebDriverProvider() {
        config = ConfigFactory.create(SmallWebDriverConfig.class, System.getProperties());
    }
...
//gradlew clean test --tests WebDriverTest -Dbrowser=Chrome -DbaseUrl=https://github.com
